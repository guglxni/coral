...
use crate::{
    RequestAuthenticator, SourceInputContext, SourceInputResolver, SourceInputResolverError,
};
...
pub(crate) struct HttpSourceClient {
    ...
    source_input_context: Option<SourceInputContext>,
...
impl HttpSourceClientRuntime {
    pub(crate) fn new(
        ...
        Self {
            source_input_context: Some(source_input_context),
...
impl HttpSourceClient {
    ...
    fn build(
        ...
        Ok(Self {
            ...
            source_input_context: runtime.source_input_context,
    ...
    pub(super) async fn resolved_inputs_for_request(
        ...
        let (Some(resolver), Some(source)) =
            (&self.source_input_resolver, &self.source_input_context)
        else {
